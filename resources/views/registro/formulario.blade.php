...
@section('title', 'Formulario del usuario')
...
@section('content')
    <div class="formulario">
        <div class="wrapper">
            ...
            <div id="icono" class="text-center form-lg">
                @if ($_GET["tipo"] == "alumno")
            ...
            <form class="form-registro reg">
                ...
                <div class="inputContainer">
                    <input name="apellidos" type="text" class="input-registro" id="apellidos" placeholder="a"
                        required />
                    <label class="labelform">
                ...
                <div class="inputContainer">
                    <input name="fecha_nacimiento" type="date" class="input-registro" id="date" placeholder="a"
                        required />
                    <label class="labelform">
                ...
                <!-- Campos especificos segun el tipo de usuario -->
                <div id="formulario" class="text-center form-lg">
                    @if ($_GET["tipo"] == "alumno")
                        <div class="inputContainer">
